...
prototxt = "../../models/caffe_model/bvlc_googlenet.prototxt"
caffeModel = "../../models/caffe_model/bvlc_googlenet.caffemodel"
with open("../../models/caffe_model/bvlc_googlenet.txt") as file:
