...
config = "../../models/tensorflow_model/graph.pbtxt"
model = "../../models/tensorflow_model/frozen_inference_graph.pb"
with open("../../models/tensorflow_model/labelmap.txt") as file:
