...
cfgFile = "../../models/darknet_model/yolov3.cfg"
darknetModel = "../../models/darknet_model/yolov3.weights"
with open("../../models/darknet_model/yolov3.txt") as file:
...
for i in indices:
    ...
    cv2.putText(
        image, labels[int(i)], (x, y), cv2.FONT_HERSHEY_COMPLEX, 1.0, (0, 0, 255)
    )
