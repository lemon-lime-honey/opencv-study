...
namespace Project
{
    class Program
    {
        ...
        {
            const string config = "../../models/tensorflow_model/graph.pbtxt";
            const string model = "../../models/tensorflow_model/frozen_inference_graph.pb";
            string[] classNames = File.ReadAllLines("../../models/tensorflow_model/labelmap.txt");

            Mat image = new Mat(@"Resources/bus.jpg");
            ...
            Mat boxes = Mat.FromPixelData(outputBlobs[0].Size(2), outputBlobs[0].Size(3), MatType.CV_32F, outputBlobs[0].Ptr(0));
