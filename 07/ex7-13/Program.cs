    ...
    class Program
    {
        ...
        static float[] HogCompute(float[] images)
        {
            ...
            for (int num = 0; num < images.Length / 784; num++)
            {
                ...
                Mat image = Mat.FromPixelData(28, 28, MatType.CV_32F, imageArray);
        ...
        static void Main(string[] args)
        {
            ...
            Mat trainX = Mat.FromPixelData(60000, trainDescriptor.Length / 60000, MatType.CV_32F, trainDescriptor);
            Mat trainY = Mat.FromPixelData(1, 60000, MatType.CV_32S, train.Item2);
            Mat testX = Mat.FromPixelData(10000, testDescriptor.Length / 10000, MatType.CV_32F, testDescriptor);
